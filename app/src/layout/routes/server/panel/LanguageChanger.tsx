...
import { HStack, Image, InputGroup, InputLeftElement, Text, useColorModeValue, useToast } from "@chakra-ui/react";
...
export default memo(function LanguageChanger({ locale }: Props) {
	...
	const [input, setInput] = useState(languages.find((lang) => lang.countryCode.toLowerCase() === locale?.toLowerCase())?.name);

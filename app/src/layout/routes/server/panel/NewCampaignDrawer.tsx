				...
				>
					<DrawerContent bg="bg">
						...
						<DrawerBody display={"flex"} flexDir={"column"} gap={6}>
							...
							<Text>
								You can create a new campaign with the available ad credits. 1 credit equals 10 impressions. Your
								server will be shown to users with same language as your server and (optionally) will be shown on
								selected tags.
							</Text>
							...
							<Flex flexDir={"column"} gap={2}>
								<Flex flexDir={"column"} gap={1}>
									...
									<Text fontWeight={500}>
										Select tags where you want to show your server. More tags means faster drain of views. No
										tags means it will show on main page or on tags page, when there's no promoted servers on
										that tag.
									</Text>
								</Flex>

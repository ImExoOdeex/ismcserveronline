                    ...
                    <Table variant={"unstyled"} size={"sm"}>
                        <Tbody>
                            ...
                            {!bedrock && (
                                <Tr>
                                    <Td>Player List</Td>
                                    {(data.players as unknown as ServerModel.Players<false>)?.list
                                        ?.length ? (
                                        <Td
                                            fontWeight={"normal"}
                                            dangerouslySetInnerHTML={{
                            ...
                            {query && (
                                <Tr>
                                    ...
                                    {(data as unknown as MinecraftServer).plugins?.length ? (
                                        <>
                                            {(data as unknown as MinecraftServer).plugins.map(
                                                (p: string) => {
                                                    return (
                    ...
                    <Table variant={"unstyled"} size={"sm"}>
                        <Tbody>
                            ...
                            <Tr>
                                <Td>Port</Td>
                                <Td fontWeight={"normal"}>
                                    {typeof data.port === "object" ? data.port?.ipv4 : data.port}
                                </Td>
                            </Tr>
                            <Tr>
                                <Td>Protocol</Td>

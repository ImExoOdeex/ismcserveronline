            ...
            <Flex w="100%" justifyContent={"space-between"}>
                <Flex gap={4} w="100%">
                    ...
                    <Flex flexDir="column" gap={1}>
                        ...
                        <Flex gap={1}>
                            <Badge colorScheme={server.bedrock ? "blue" : "purple"}>
                                {server.bedrock ? "Bedrock" : "Java"}
                            </Badge>
                        ...
                        <Text fontSize="sm">
                            {(server?.players as unknown as ServerModel.Players<any>).online}{" "}
                            players
                        </Text>
                    </Flex>
                </Flex>

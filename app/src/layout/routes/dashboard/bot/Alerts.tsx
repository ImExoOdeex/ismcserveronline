...
export default memo(function Alerts({ livecheckFetcher }: Props) {
    ...
    return (
        <>
            <Tooltip
                label={"You can't set up alerts, when livecheck is disabled."}
                isDisabled={!!livecheck}
                hasArrow
            >
                    ...
                    {alertEnabled && (
                        ...
                        >
                            <Flex flexDir={"column"} gap={0}>
                                ...
                                <Text color={"textSec"}>
                                    Select a channel you'd like to be notified in.
                                </Text>
                            </Flex>
                            ...
                            <Select
                                ...
                                value={{
                                    label:
                                        channels.find((channel) => channel.id === alertChannel)

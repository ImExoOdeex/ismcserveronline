                            ...
                            >
                                <VStack spacing={10} w='100%' pt={10} align={"center"}>
                                    ...
                                    <Stack w='100%' maxW={'1200px'} mx='auto' spacing={5} pos={'relative'}
                                        ...
                                        <Image src="/webp/statusbotlogo512.webp" rounded={'2xl'} h='300px' boxShadow={'md'} border="2px solid white" />
                                        ...
                                        <VStack w='100%' align={"start"} spacing={5}>
                                            ...
                                            >
                                                <Stack w='100%' py={{ base: 5, sm: 3 }} px={3} h='100%' alignItems={'center'} justifyContent={'center'} boxShadow={'lg'} transition={'.2s'}
                                                    ...
                                                    as={Link} href={links.discordBotInvite}
                                                >
                                            ...
                                            >
                                                <Stack w='100%' py={{ base: 5, sm: 3 }} px={3} h='100%' alignItems={'center'} justifyContent={'center'} boxShadow={'lg'} transition={'.2s'}
                                                    ...
                                                    as={Link} href={links.discordServerInvite}>

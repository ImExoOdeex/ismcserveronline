...
export default function SystemInfo({ system }: Props) {
    return (
        <VStack align={'start'}>
            ...
            <Text fontWeight={500}>System memory: {system.usedMem.toFixed(0)}/{system.totalMem.toFixed(0)}MB</Text>
            <Text fontWeight={500}>Platform: {system.platform} {system.arch}, {system.cpu}</Text>

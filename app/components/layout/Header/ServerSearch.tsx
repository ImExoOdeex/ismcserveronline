...
import { Box, chakra, Flex, HStack, Input, shouldForwardProp, Text } from "@chakra-ui/react";
...
export default function ServerSearch() {
    ...
    return (
        <HStack>
            ...
            <Flex w='200%' h='30px' pos={'relative'}>
                <ChakraInput as={motion.input} h='100%' w='200px' rounded='xl' bg='alpha100' placeholder="Server Name" onFocus={() => setSearching(true)} onBlur={() => setSearching(false)}
                    variants={variants} animate={searching ? "open" : "close"} pl={'26px'} _focus={{ outlineColor: 'transparent', outlineWidth: 0 }}
                    // @ts-ignore

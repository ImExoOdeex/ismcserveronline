        ...
        <VStack maxW={"1200px"} w="100%" align={"start"} mx="auto" px={4} spacing={7} mt={10}>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    Query is a protocol used to get information about server. It's less known than
                    status protocol and it has to be enabled in server.properties file. It allows to
                    get more information about server, but it's slower.
                </Text>
            </VStack>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    You can use the same way as in game. Add the <Badge>:</Badge> and port you want
                    to check after the domain.
                </Text>
            </VStack>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    ...
                    <Code colorScheme={"purple"}>server.properties</Code> file. This will result
                    disabling status directly in game, but this won't affect connecting to server.
                </Text>
            </VStack>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    ...
                    <Code colorScheme={"purple"}>query-plugins</Code> to false in your{" "}
                    <Code colorScheme={"purple"}>bukkit.yml</Code> file.
                </Text>
            </VStack>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    Minecraft servers only return a maximum of 12 random players when requesting the
                    status. Some servers can override it to show additional information for users.
                </Text>
            </VStack>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    Ping is a latency from request to origin server. Our API is located in central
                    europe, that means ping between you and server can be different.
                </Text>
            </VStack>
            ...
            <VStack align={"start"}>
                ...
                <Text color={"textSec"} fontWeight={500}>
                    Yes, our API <b>caches</b> responses for only <b>15 seconds</b> to prevent
                    spamming requests to servers, so API does not get ratelimited!
                </Text>
            </VStack>

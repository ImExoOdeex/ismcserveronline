        ...
        <Flex gap={10} w="100%" flexDir={"column"}>
            <Flex w="100%" gap={5} flexDir={"column"} as={fetcher.Form} method="PATCH">
                ...
                >
                    <Flex flexDir={"column"} gap={1}>
                        ...
                        <Text color="textSec">
                            Webhook URL that our server will POST to it, when someone votes for your
                            server.
                        </Text>
                    </Flex>
                    ...
                    <Input
                        ...
                        isInvalid={
                            !!webhookUrl && !webhookUrl?.match(/^(https?):\/\/[^\s$.?#].[^\s]*$/)
                        }
                        minLength={5}
                        maxLength={256}
                        variant={"filled"}
                ...
                >
                    <Flex flexDir={"column"} gap={1}>
                        ...
                        <Text color="textSec">
                            Set the password for authorizing webhook. Check the "Authorization"
                            header in the request and make sure it's same one you set here.
                        </Text>
                    </Flex>
                ...
                <Flex gap={2} alignItems={"center"} w="100%" justifyContent={"flex-end"}>
                    <Button
                        ...
                        type="submit"
                        isLoading={
                            fetcher.state !== "idle" && fetcher.formData?.get("intent") === "test"
                        }
                        name="intent"
                        value="test"
                    >
            ...
            <Flex w="100%" gap={5} flexDir={"column"}>
                <Flex flexDir={"column"} gap={1}>
                    ...
                    <Text color="textSec">
                        You can use webhooks to get notified when someone votes for your server. We
                        will send a POST request to the URL you set, when someone votes for your
                        server. You can use this feature to reward your players for voting.
                    </Text>
                </Flex>
                ...
                <Flex flexDir={"column"} gap={1}>
                    ...
                    <Text color="textSec">
                        At your end, you need to check if the "Authorization" header matches the
                        password you set here. This prevents unauthorized requests to your webhook
                        URL. Example in JavaScript:
                    </Text>
                    <Code>
                        {`if (request.headers.authorization === "${data.vote_webhook_password?.replace(
                            /./g,
                            "*"
                        )}") {

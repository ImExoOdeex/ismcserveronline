    ...
    return (
        <Flex gap={5} w="100%" flexDir={"column"}>
                                ...
                                <Flex flexDir={"column"} w="100%" gap={4}>
                                    ...
                                    <Text>
                                        ...
                                        {data?.cancel_at_period_end &&
											...
											${new Date(
                                                data.current_period_end * 1000
                                            ).toLocaleDateString()}. You won't be charged
											anymore.`}
                                    </Text>
                                </Flex>
                            )}
            ...
            {!prime && (
                <>
                    <Text color="textSec">
                        Hey, we have spent a lot of time and effort into making the best features
                        for you and your server. Prime subscription is a way to support us and
                        unlock all awesome features! It's your decision which prime plan you'll take
                        :3
                    </Text>
                    <Flex flexDir={"column"} gap={2}>
                        ...
                        <UnorderedList>
                            ...
                            <ListItem>
                                Real-time server stats, including server & system info
                            </ListItem>
                            <ListItem>
                                <HStack>
                                    <Text>2x less voting cooldown</Text>
                                    <Tooltip
                                        label="Users voting on your server will have 2x faster voting waiting time"
                                        hasArrow
                                    >
                            ...
                            <ListItem>
                                <HStack>
                                    ...
                                    <Tooltip
                                        label="User votes will be doubled on weekends"
                                        hasArrow
                                    >
                                        <InfoIcon color="textSec" boxSize={4} cursor={"pointer"} />
                                    </Tooltip>
                        ...
                        <UnorderedList>
                            <ListItem>
                                <HStack>
                                    ...
                                    <Tooltip
                                        label="User will have prime for every owned server"
                                        hasArrow
                                    >
                                        <InfoIcon color="textSec" boxSize={4} cursor={"pointer"} />
                                    </Tooltip>
                            ...
                            <ListItem>
                                <HStack>
                                    ...
                                    <Tooltip
                                        label="User has no voting cooldown for every server"
                                        hasArrow
                                    >
                                        <InfoIcon color="textSec" boxSize={4} cursor={"pointer"} />
                                    </Tooltip>
                            ...
                            <ListItem>
                                <HStack>
                                    <Text>Doubled votes on weekends</Text>
                                    <Tooltip
                                        label="User votes will be doubled on weekends on any server"
                                        hasArrow
                                    >
                                        <InfoIcon color="textSec" boxSize={4} cursor={"pointer"} />
                                    </Tooltip>

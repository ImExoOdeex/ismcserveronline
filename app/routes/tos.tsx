        ...
        >
            ...
            <OrderedList spacing={10} listStylePos={"inside"} marginInlineStart={0}>
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <UnorderedList listStylePos={"inside"} spacing={2}>
                        ...
                        <ListItem>
                            ...
                            ismcserver.online employee, another user, or any other person or entity.
                        </ListItem>
                        <ListItem>
                            ...
                            ismcserver.online or users of the Site or expose them to liability.
                        </ListItem>
                    </UnorderedList>
                </VStack>
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        ...
                        ismcserver.online, its licensors, or other providers of such material and
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        ismcserver.online does not guarantee, represent, or warrant that your use of
                        the Site will be uninterrupted or error-free, and you agree that from time
                        to time, ismcserver.online may remove the Site for indefinite periods of
                        time or cancel the Site at any time, without notice to you.
                    </Text>
                </VStack>
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        In no event shall ismcserver.online, its officers, directors, employees, or
                        ...
                        the Site, (iii) any unauthorized access to or use of our secure servers
                        ...
                        transmitted to or through the Site by any third party, and/or (v) any errors
                        ...
                        otherwise made available via the Site, whether based on warranty, contract,
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        You agree to indemnify, defend, and hold harmless ismcserver.online, its
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        ...
                        them or their subject matter or formation (including without limitation any
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        ismcserver.online may revise and update these Terms from time to time in its
                        sole discretion. All changes are effective immediately when we post them,
                        and apply to all access to and use of the Site thereafter. Your continued
                        use of the Site following the posting of revised Terms means that you accept
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        ismcserver.online reserves the right to terminate your access to the Site at
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        ...
                        ismcserver.online regarding the use of the Site. If any provision of these
                        Terms is held to be invalid or unenforceable, such provision shall be struck
                        and the remaining provisions shall be enforced. ismcserver.online's failure
                        to enforce any right or provision in these Terms shall not constitute a
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <VStack align={"start"}>
                        <Text>
                            You can verify your server if it's yours server only or have permission
                            from the owner.
                        </Text>

                        <Text>- Verify only servers you have permission from.</Text>
                        <Text>
                            - Verification allows you to customizing server's tags, description and
                            all other stuff.
                        </Text>
                        ...
                        <Text>
                            - We reserve the right to remove your server verification without any
                            reason.
                        </Text>
                        <Text>
                            - After you've verified your server, you can generate a server token. Do
                            not ever share it to anyone else, since it's your private token to use
                            in our services to identify you.
                        </Text>
                    </VStack>
                </VStack>
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <VStack align={"start"}>
                        <Text>
                            Prime subscription is a subscription plan that can be bought by user for
                            user or their verified server. Prime has plenty of features to use.
                        </Text>

                        <Text>
                            - There are 2 prime subscriptions. "User" and "Server", each has
                            different features. (see <Link to="/prime">Prime page</Link>)
                        </Text>
                        <Text>
                            - Subscription renews automatically every month. You can cancel it
                            anytime in dashboard.
                        </Text>
                        <Text>
                            - If you cancel your subscription, you will still have prime features
                            until the end of the month you paid for.
                        </Text>
                        <Text>- We don't refund any payments.</Text>
                        <Text>
                            - We reserve the right to remove your prime subscription without any
                            reason.
                        </Text>
                        <Text>
                            - We reserve the right to change prime subscription features at any
                            time.
                        </Text>
                        <Text>
                            - Prime subscription helps us to keep this website alive. Thanks for
                            supporting us!
                        </Text>
                        <Text>
                            - If you have any questions about prime subscription or need any help
                            related to it, feel free to contact us on our{" "}
            ...
            <OrderedList spacing={10} listStylePos={"inside"} marginInlineStart={0}>
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        If you want to pernamently delete your data from our database, you can just
                        kick the bot. It will automatically delelete all livechecks and all config.
                        If you want to make sure your data has been deleted you can join{" "}
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        Users can make up to 5 livechecks per server. Livechecks cannot be on the
                        one channel. You can enable/disable/edit the livechecks and config via the{" "}
                ...
                <VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
                    ...
                    <Text>
                        We store your guild Id, channel Id and livecheck message Id as a data from
                        discord. Of course we store your Minecraft server ip, it's edition, online
                        and offline config colors as data provided from you in dashboard (if
                        provided).
                    </Text>
                </VStack>
            </OrderedList>

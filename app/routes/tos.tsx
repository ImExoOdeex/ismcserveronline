			...
			>
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<UnorderedList listStylePos={"inside"} spacing={2}>
						<ListItem>
							...
							the export of data or software to and from the
							United States or other countries).
						</ListItem>
						<ListItem>
							To impersonate or attempt to impersonate
							ismcserver.online, a ismcserver.online employee,
							another user, or any other person or entity.
						</ListItem>
						<ListItem>
							To engage in any other conduct that restricts or
							inhibits anyone's use or enjoyment of the Site, or
							which, as determined by us, may harm
							ismcserver.online or users of the Site or expose
							them to liability.
						</ListItem>
					</UnorderedList>
				</VStack>
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						...
						thereof), are owned by ismcserver.online, its licensors,
						or other providers of such material and are protected by
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						ismcserver.online does not guarantee, represent, or
						warrant that your use of the Site will be uninterrupted
						or error-free, and you agree that from time to time,
						ismcserver.online may remove the Site for indefinite
						periods of time or cancel the Site at any time, without
						notice to you.
					</Text>
				</VStack>
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						In no event shall ismcserver.online, its officers,
						directors, employees, or agents, be liable to you for
						any direct, indirect, incidental, special, punitive, or
						consequential damages whatsoever resulting from any (i)
						errors, mistakes, or inaccuracies of content, (ii)
						personal injury or property damage, of any nature
						whatsoever, resulting from your access to and use of the
						Site, (iii) any unauthorized access to or use of our
						...
						Site, (iv) any bugs, viruses, trojan horses, or the
						like, which may be transmitted to or through the Site by
						any third party, and/or (v) any errors or omissions in
						...
						the Site, whether based on warranty, contract, tort, or
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						...
						ismcserver.online, its affiliates, licensors, and
						service providers, and its and their respective
						officers, directors, employees, contractors, agents,
						licensors, suppliers, successors, and assigns from and
						against any claims, liabilities, damages, judgments,
						awards, losses, costs, expenses, or fees (including
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						...
						in connection with them or their subject matter or
						formation (including without limitation any
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						ismcserver.online may revise and update these Terms from
						time to time in its sole discretion. All changes are
						effective immediately when we post them, and apply to
						all access to and use of the Site thereafter. Your
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						ismcserver.online reserves the right to terminate your
						access to the Site at any time without notice for any
						reason whatsoever.
					</Text>
				</VStack>
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						...
						and ismcserver.online regarding the use of the Site. If
						...
						ismcserver.online's failure to enforce any right or
						provision in these Terms shall not constitute a waiver
						of such right or provision unless acknowledged and
				...
				<VStack w="100%" spacing={5} align={"start"} fontSize={"sm"}>
					...
					<Text>
						Please <b>do not</b> ddos the API to keep fair user
						experience. Thanks!
					</Text>
				</VStack>
			</OrderedList>

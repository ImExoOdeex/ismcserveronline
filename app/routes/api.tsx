                    ...
                    >
                        ...
                        <VStack alignItems={"start"} textAlign={"left"} w="100%" spacing={6}>
                            ...
                            <Text fontWeight={500} color={"textSec"}>
                                IsMcServer.online API is a free-to-use API, that allows checking any
                                Minecraft Server status. To generate API token join our Discord
                                server and navigate to{" "}
                                <Badge textTransform={"lowercase"}>#generate-token</Badge> text
                                channel. Use{" "}
                                <Badge textTransform={"lowercase"}>/generatetoken</Badge> command to
                                get your new private token!
                            </Text>
                    ...
                    <VStack w="100%" align={"start"} spacing={16}>
                        <VStack w="100%" alignItems={"start"} spacing={2}>
                            ...
                            <Text>
                                ...
                                <Badge>Authorization</Badge> header, like shown on example below. It
                                is important to note that API tokens should be kept secure and not
                            ...
                            >
                                <ListItem>
                                    Obtain an API token: You need to get an API token in order to
                                    use the API. This token is used to authenticate your API
                                    requests and ensure that your usage is authorized.
                                </ListItem>
                                <ListItem>
                                    Include the token in the request header: Once you have the API
                                    token, you need to include it in the "Authorization" header of
                                    your API request. This header is used to pass along your API
                                    token, so that the API server can verify your authorization.
                                </ListItem>
                                <ListItem>
                                    Send the API request: After you have included the API token in
                                    the request header, you can send the API request to the server
                                    and receive a response. The response will contain the data you
                                    requested, as well as any other relevant information.
                                </ListItem>
                                <ListItem>
                                    Keep your token secure: It is important to keep your API token
                                    secure and not share it with unauthorized users.
                                </ListItem>
                            </OrderedList>

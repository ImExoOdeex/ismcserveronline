        ...
        <Flex gap={10} w="100%" flexDir={"column"}>
            <Flex flexDir={"column"} gap={5}>
                <Flex flexDir={"column"} gap={1}>
                    ...
                    <Text color="textSec">
                        Ads are easy way to promote your server. You can create a new campaign with
                        the available ad credits.
                    </Text>
                </Flex>
            ...
            <Flex flexDir={"column"} gap={2}>
                ...
                <Flex flexDir={"column"} gap={2}>
                    <Text fontWeight={500}>
                        You can promote your server by creating an ad campaign. 1 Credit is equal to
                        20 views.
                    </Text>
